...
picks:
  ...
  Jearvon:
    - text: Lake Street Dive
      url: http://www.lakestreetdive.com/
    - text: Strange Loop
      url: https://www.youtube.com/channel/UC_QIfHvN9auy2CoOdSfMWD
  Justin:
    - text: "Geometry Wars 3 Dimensions - Wikipedia, the free encyclopedia"
      url: http://en.wikipedia.org/wiki/Geometry_Wars_3:_Dimensions
---
